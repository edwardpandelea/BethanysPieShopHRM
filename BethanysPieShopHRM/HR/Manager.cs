...
namespace BethanysPieShopHRM.HR
{
    ...
    {
        public Manager(string firstName, string lastName, string email, DateTime birthDay, double? hourlyRate, string street, string houseNumber, string zip, string city) : base(firstName, lastName, email, birthDay, hourlyRate, street, houseNumber, zip, city)
        {
        }
