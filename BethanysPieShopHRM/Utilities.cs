    ...
    internal class Utilities
    {
        ...
        internal static void RegisterEmployee(List<Employee> employees)
        {
            ...
            switch (employeeType)
            {
                ...
                case "4":
                    ...
                    break;
                case "5":
                    employee = new JuniorReasearcher(firstName, lastName, email, birthDay, rate);
                    break;
            }
                    ...
                    for (int i = 0; i < employeesAsString.Length; i++)
                    {
                        ...
                        switch (employeeType)
                        {
                            ...
                            case "4":
                                ...
                                break;
                            case "5":
                                employee = new JuniorReasearcher(firstName, lastName, email, birthDay, hourlyRate);
                                break;
                        }
        ...
        private static string GetEmployeeType(Employee employee)
        {
            if (employee is Manager)
                ...
                return "3";
            else if (employee is JuniorReasearcher)
                return "5";
